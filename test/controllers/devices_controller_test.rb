...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { eoj: @device.eoj, ipaddr: @device.ipaddr, name: @device.name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { eoj: @device.eoj, ipaddr: @device.ipaddr, name: @device.name } }
